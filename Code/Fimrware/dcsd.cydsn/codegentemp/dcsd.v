...
module top ;
    ...
    if (1)
    begin : QDEC
        reg [4:0] tmp__QDEC_reg;
        wire [3:0] tmp__QDEC_ins;
        assign tmp__QDEC_ins = {Net_817,Net_810,Net_1008,Net_1006};
        always @(posedge Net_2266)
        begin
            case (tmp__QDEC_ins)
                4'b0000 :  tmp__QDEC_reg = 5'b00000;
                4'b0001 :  tmp__QDEC_reg = 5'b00010;
                4'b0010 :  tmp__QDEC_reg = 5'b00011;
                4'b0011 :  tmp__QDEC_reg = 5'b10000;
                4'b0100 :  tmp__QDEC_reg = 5'b00111;
                4'b0101 :  tmp__QDEC_reg = 5'b00100;
                4'b0110 :  tmp__QDEC_reg = 5'b10100;
                4'b0111 :  tmp__QDEC_reg = 5'b00110;
                4'b1000 :  tmp__QDEC_reg = 5'b01010;
                4'b1001 :  tmp__QDEC_reg = 5'b11000;
                4'b1010 :  tmp__QDEC_reg = 5'b01000;
                4'b1011 :  tmp__QDEC_reg = 5'b01011;
                4'b1100 :  tmp__QDEC_reg = 5'b11100;
                4'b1101 :  tmp__QDEC_reg = 5'b01111;
                4'b1110 :  tmp__QDEC_reg = 5'b01110;
                4'b1111 :  tmp__QDEC_reg = 5'b01100;
            endcase
        end
        assign {Net_1014,Net_1008,Net_1006,pulse,Net_4507} = tmp__QDEC_reg;
    end
    // -- LUT QDEC end --

    assign Net_7565 = 1'h1;
    ...
    CyStatusReg_v1_90 QDEC_FAULT (
        ...
        .intr(Net_9302),
        .status_bus(8'b0));
    defparam QDEC_FAULT.Bit0Mode = 0;
    defparam QDEC_FAULT.Bit1Mode = 0;
    defparam QDEC_FAULT.Bit2Mode = 0;
    defparam QDEC_FAULT.Bit3Mode = 0;
    defparam QDEC_FAULT.Bit4Mode = 0;
    defparam QDEC_FAULT.Bit5Mode = 0;
    defparam QDEC_FAULT.Bit6Mode = 0;
    defparam QDEC_FAULT.Bit7Mode = 0;
    defparam QDEC_FAULT.BusDisplay = 0;
    defparam QDEC_FAULT.Interrupt = 0;
    defparam QDEC_FAULT.MaskValue = 0;
    defparam QDEC_FAULT.NumInputs = 1;
	...
	cy_clock_v1_0
		#(.id("e01d0c9e-7a62-4294-9e3c-1a0a464240ca"),
		  .source_clock_id("ccced5a2-6965-48d4-b176-1577322fcb4e"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_9436 or posedge Net_1014)
    begin
        if (Net_9436)
        begin
            cydff_1 <= 0;
    ...
    assign Net_7566 = cydff_1;
    // -- DFF End --

    CyControlReg_v1_80 RESET_FAULT (
        .control_1(Net_9433),
        .control_2(Net_9434),
        .control_3(Net_9435),
        .control_0(Net_9436),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam RESET_FAULT.Bit0Mode = 0;
    defparam RESET_FAULT.Bit1Mode = 0;
    defparam RESET_FAULT.Bit2Mode = 0;
    defparam RESET_FAULT.Bit3Mode = 0;
    defparam RESET_FAULT.Bit4Mode = 0;
    defparam RESET_FAULT.Bit5Mode = 0;
    defparam RESET_FAULT.Bit6Mode = 0;
    defparam RESET_FAULT.Bit7Mode = 0;
    defparam RESET_FAULT.BitValue = 0;
    defparam RESET_FAULT.BusDisplay = 0;
    defparam RESET_FAULT.ExtrReset = 0;
    defparam RESET_FAULT.NumOutputs = 1;
	...
	cy_clock_v1_0
		#(.id("70dd3fae-e80e-4947-beaf-d2d96c8c1167"),
		  .source_clock_id("ccced5a2-6965-48d4-b176-1577322fcb4e"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    CyStatusReg_v1_90 QDEC_DIR (
        ...
        .intr(Net_9284),
        .status_bus(8'b0));
    defparam QDEC_DIR.Bit0Mode = 0;
    defparam QDEC_DIR.Bit1Mode = 0;
    defparam QDEC_DIR.Bit2Mode = 0;
    defparam QDEC_DIR.Bit3Mode = 0;
    defparam QDEC_DIR.Bit4Mode = 0;
    defparam QDEC_DIR.Bit5Mode = 0;
    defparam QDEC_DIR.Bit6Mode = 0;
    defparam QDEC_DIR.Bit7Mode = 0;
    defparam QDEC_DIR.BusDisplay = 0;
    defparam QDEC_DIR.Interrupt = 0;
    defparam QDEC_DIR.MaskValue = 0;
    defparam QDEC_DIR.NumInputs = 1;
