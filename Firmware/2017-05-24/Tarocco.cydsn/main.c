...
int main() {
    ...
    int16_t millivolts=0, duty_reduce=0,error=0, error_derivative=0, error_at_timeout=0, error_prev=0;
    ...
    static const CYCODE uint8_t current_setting=255, invert_motor=0, uart_data=1;
    ...
    volatile const uint8_t *eeprom_current_setting, *eeprom_invert_motor, *eeprom_uart_data;
