// ======================================================================
// Tarocco.v generated from TopDesign.cysch
// 03/21/2021 at 16:05
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=0, TCPeriod=1874, TCPrescaler=6, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=TX_SEND, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TX_SEND, CY_INSTANCE_SHORT_NAME=TX_SEND, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=TX_SEND, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=5, CompareModeSoftware=1, CompareStatusEdgeSense=true, CompareValue=65535, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=65534, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65534, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=false, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=ERROR_COUNTER, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ERROR_COUNTER, CY_INSTANCE_SHORT_NAME=ERROR_COUNTER, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ERROR_COUNTER, )
...
module top ;
          ...
          wire  Net_14381;
          wire  Net_14380;
    electrical  Net_14619;
          wire  Net_14643;
          wire  Net_14642;
          wire  Net_14641;
    electrical  Net_14640;
	...
	cy_isr_v1_0
		#(.int_type(2'b01))
		rxISR
		 (.int_signal(Net_14379));


    TCPWM_P4_v2_10_3 TX_SEND (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_14035)
    begin
        cydff_1 <= Net_14013[1];
    end
    assign Net_14014 = cydff_1;
    // -- DFF End --
    ...
    cy_sync_v1_0 Sync_3 (
        ...
        .clock(Net_14035),
        .s_out(Net_14013[3:0]));
    defparam Sync_3.SignalWidth = 4;


    assign Net_13954 = Net_14013[0] ^ Net_14014;


    assign Net_13981 = Net_14013[0] ^ Net_13956 ^ Net_14014 ^ Net_14013[1];

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_13954 or Net_14013 or Net_14123)
        begin
            case (Net_14123[1])
                1'b0 :  tmp__mux_1_reg = Net_13954;
                1'b1 :  tmp__mux_1_reg = Net_14013[2];
            endcase
        end
        assign Net_14175 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_13997 or Net_13981 or Net_14043 or Net_14016 or Net_14123)
        begin
            case (Net_14123[1:0])
                2'b00 :  tmp__mux_2_reg = Net_13997;
                2'b01 :  tmp__mux_2_reg = Net_13981;
                2'b10 :  tmp__mux_2_reg = Net_14043;
                2'b11 :  tmp__mux_2_reg = Net_14016;
            endcase
        end
        assign Net_14216 = tmp__mux_2_reg;
    end
    // -- Mux end --
    ...
    assign Net_13997 = 1'h0;

    assign Net_14043 = 1'h0;
    ...
    Counter_v3_0_4 ERROR_COUNTER (
        ...
        .up_ndown(Net_14279),
        .count(Net_14338));
    defparam ERROR_COUNTER.CaptureMode = 0;
    defparam ERROR_COUNTER.ClockMode = 1;
    defparam ERROR_COUNTER.CompareMode = 5;
    defparam ERROR_COUNTER.CompareStatusEdgeSense = 1;
    defparam ERROR_COUNTER.EnableMode = 0;
    defparam ERROR_COUNTER.ReloadOnCapture = 0;
    defparam ERROR_COUNTER.ReloadOnCompare = 0;
    defparam ERROR_COUNTER.ReloadOnOverUnder = 0;
    defparam ERROR_COUNTER.ReloadOnReset = 0;
    defparam ERROR_COUNTER.Resolution = 16;
    defparam ERROR_COUNTER.RunMode = 0;
    defparam ERROR_COUNTER.UseInterrupt = 1;
    ...
    assign Net_13972 = 1'h1;

    assign Net_14041 = 1'h0;

    assign Net_13974 = 1'h0;

    // -- DFF Start --
    reg  dir_sync_ff;
    always @(posedge Net_14313)
    begin
        dir_sync_ff <= Net_14175;
    end
    assign Net_14279 = dir_sync_ff;
    // -- DFF End --
    ...
    always @(posedge Net_14313)
    begin
        step_syn_ff <= Net_14216;
    end
    assign Net_14338 = step_syn_ff;
    // -- DFF End --
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		pwmISR
		 (.int_signal(Net_14374));


    CyStatusReg_v1_90 step_register (
        .status_0(Net_14016),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .intr(Net_14407),
        .status_bus(8'b0));
    defparam step_register.Bit0Mode = 1;
    defparam step_register.Bit1Mode = 0;
    defparam step_register.Bit2Mode = 0;
    defparam step_register.Bit3Mode = 0;
    defparam step_register.Bit4Mode = 0;
    defparam step_register.Bit5Mode = 0;
    defparam step_register.Bit6Mode = 0;
    defparam step_register.Bit7Mode = 0;
    defparam step_register.BusDisplay = 0;
    defparam step_register.Interrupt = 0;
    defparam step_register.MaskValue = 0;
    defparam step_register.NumInputs = 1;
